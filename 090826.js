...
// Create a function named main (PlayTurn for C#) that calls the 
// functions in the proper order stated before.
...
// - rollDice
// - move
// Note: this list only mentions the methods' names, not the order 
// in which they should be called. For the order, refer to the first 
// paragraph.
...
// })
    ...
    var health = 100, position = 0, coins = 0
