...
// piece should become two 20p pieces and one 10p piece, but a 20p piece 
// should become two 10p pieces.

// The machine can exclusively process these coins and notes: £5, £2, £1, 
// 50p, 20p. Any coins and notes which are not accepted by the machine will 
// be returned unprocessed. For example, if you were to put a £20 note into 
// the machine, it would be returned to you and not broken into change. (Note 
//     that £1 is worth 100p.)
