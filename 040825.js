  // CHALLENGE NAME-  For Twins: 1. Types
    ...
    Task:
    // Write a function that will accept two parameters: variable and 
    // type and check if type of variable is matching type. Return true 
    // if types match or false if not.
