...
// Suzuki is a monk who climbs a large staircase to the monastery as part of a ritual. Some
//  days he climbs more stairs than others depending on the number of students he must 
//  train in the morning. He is curious how many stairs might be climbed over the next 
...
// in a year. You will have all data for the entire year so regardless of how it is logged 
...
return s.join(',').split(',').reduce((a,b)=>+a+ +b)*20
