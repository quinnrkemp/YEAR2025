  // CHALLENGE NAME-  Improving Math.round(x)
    ...
    // Javascript has a handy built-in Math.round(x) method that rounds 
    ...
    // But that is sometimes not enough! What if we wanted to round 
    // 3.1415926535 to two decimal places? While some languages (such as 
    //     PHP) has a round() function that supports rounding to a specified 
    //     number of decimal places (e.g. <?php round(3.1415926535, 4); /* 3.1416 
