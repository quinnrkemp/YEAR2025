  // CHALLENGE NAME-  The Wide-Mouthed frog!
    ...
    // He just can't stop asking the creatures he encounters what they 
    // like to eat. But, then he meets the alligator who just LOVES to 
    // eat wide-mouthed frogs!
    
    // When he meets the alligator, it then makes a tiny mouth.
    
    // Your goal in this kata is to create complete the mouth_size method 
    // this method takes one argument animal which corresponds to the 
    ...
    function mouthSize(a) {
        return a.toLowerCase()!='alligator'?'wide':'small'
          // code here
        }