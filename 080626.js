...
// You should return the result of applying the given operation to 
// these numbers.

// Note: In dynamically typed languages (JS, PHP, Python), the first 
// and second arguments can be not numbers. In that case, return 
// "unknown value".

// If the given operation to perform on the two numbers is not one 
// of the four mentioned above, you should:
...
function calculator(a,b,sign){
  if((sign != "+" && sign != "-" && sign != "*" && sign != "/") || (typeof a != "number" || typeof b != "number")){
