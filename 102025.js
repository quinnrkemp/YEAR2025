...
// eating my sheep". Otherwise, return "Oi! Sheep number N! You are about to 
// be eaten by a wolf!" where N is the sheep's position in the queue.
...
let wolfy=q.reverse().indexOf('wolf')
return wolfy===0?`Pls go away and stop eating my sheep`:`Oi! Sheep number ${wolfy}! You are about to be eaten by a wolf!`
}    